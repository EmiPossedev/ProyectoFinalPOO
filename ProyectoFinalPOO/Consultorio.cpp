...
bool coincide(const Turno &turno, const string &valor)
{
	...
	// O coincide el dni del KinesiÛlogo
...
void Consultorio::cargarKinesiologos(const string &nombreArchivo)
{
    ...
    if (!bin.is_open())
    {
        throw runtime_error("No se pudo abrir el archivo kinesi√≥logos para lectura.");
    }
...
void Consultorio::eliminarPacientePorDni(const string &dniKine)
{
    ...
    cout << "No se encontr√≥ paciente con ese DNI." << std::endl;
}
...
void Consultorio::eliminarKinesiologoPorDni(const string &dniKine)
{
    ...
    cout << "No se encontr√≥ kinesiologo con ese DNI." << endl;
}
...
void Consultorio::eliminarTurno(const string &dniPacienteBuscado, const Fecha &fecha, const string &hora)
{
    ...
    cout << "No se encontrÛ turno con esos datos." << endl;
}
...
void Consultorio::actualizarTurno(Turno turnoViejo, Turno turnoNuevo) {
	...
	cout << "Error: No se encontrÛ el turno viejo en la memoria." << endl;
}
